...
- The shared test fixture explicitly overrides host and dotenv provider/LLM credentials with empty values to keep unconfigured-route tests deterministic.
...
Result: `135 passed in 5.09s`, exit code 0.
...
Result: `12 passed in 0.79s`, exit code 0.
...
Result: `95 passed in 3.29s`, exit code 0.
...
| GAP-007 | The cross-platform baseline is restored and expanded from 96 to 135 passing tests. |
